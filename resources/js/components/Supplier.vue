    ...
    <div>
        ...
        <div class="social " data-pages="social">
            ...
            <div class="jumbotron" data-social="cover" data-pages="parallax" style="height: 200px">
                ...
                <img alt="Cover photo" src="assets/img/cover/c8.jpg" style="width: 100%" />
                </div>
                <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
                <div class="inner">
                    <div class="pull-bottom bottom-left m-b-40 sm-p-l-15">
                    <h1 class="text-white no-margin" style="text-shadow: 3px 2px 5px #131313"><span class="semi-bold">Supplier</span> Produk</h1>
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="container-fluid container-fixed-lg ">
            <div class="row jutify-content-center">
                ...
                <div class="col-sm-6 col-12 px-4" v-if="$gate.isAdmin() || $gate.isManager()">
                    <div class="float-right">
                        <button class="btn btn-success mr-2" @click="addModal">
                        <i class="fas fa-plus fa-fw"></i>    Data Supplier</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <v-table class="wrap table table-hover tableFixHead text-nowrap" id="table"
                            ...
                            <thead slot="head" style="bg-white">
                                <tr>
                                    ...
                                    <v-th sortKey="perusahaan">perusahaan</v-th>
                                    <v-th sortKey="alamat">Alamat</v-th>
                                    <v-th sortKey="email">E-mail</v-th>
                                    <v-th sortKey="telepon">telepon/HP</v-th>
                                    <v-th sortKey="updated_at" defaultSort="desc" v-if="$gate.isAdmin() || $gate.isManager()">Aksi</v-th>
                                </tr>
                            </thead>
                            <tbody slot="body" slot-scope="{displayData}">
                                ...
                                <tr v-for="row in displayData" :key="row.id">
                                    ...
                                    <td style="width: 100px" v-if="$gate.isAdmin() || $gate.isManager()">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode" id="exampleModalCenterTitle">Tambah Supplier Baru</h5>
                    <h5 class="modal-title" v-show="editmode" id="exampleModalCenterTitle">Edit Supplier</h5>
                ...
                <form @submit.prevent ="editmode ? updateData() : createData()">
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input v-model="form.nama" type="text" name="nama" placeholder="Nama Supplier"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input v-model="form.perusahaan" type="text" name="perusahaan" placeholder="Nama Perusahaan"
                                    class="form-control" :class="{ 'is-invalid': form.errors.has('perusahaan')}">
                                <has-error :form="form" field="perusahaan"></has-error>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Alamat</label>
                            <div class="col-sm-10">
                                <textarea v-model="form.alamat" type="texta" name="alamat" placeholder="Alamat Supplier"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input v-model="form.email" type="email" name="email" placeholder="E-mail Supplier"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input v-model="form.telepon" type="number" name="telepon" placeholder="telepon Supplier"
    ...
    export default {
        ...
        methods:{
            ...
            deleteData(id){
                Swal.fire({
                    title: 'Anda Yakin?',
                    text: "Supplier yang dihapus tidak dapat dikembalikan!",
                    icon: 'question',
