...
<div class="content" style="min-height: 660px;">
    ...
    <div class="social " data-pages="social">
        ...
        <div class="jumbotron" data-social="cover" data-pages="parallax" style="height: 200px">
            ...
            <img alt="Cover photo" src="assets/img/cover/c1.jpg" style="width: 100%" />
            </div>
            <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <div class="pull-bottom bottom-left m-b-40 sm-p-l-15">
                <h1 class="text-white no-margin" style="text-shadow: 3px 2px 5px #131313"><span class="semi-bold">Pelanggan</span> Trison</h1>
                </div>
            </div>
            </div>
        </div>
    ...
    <div class="container-fluid container-fixed-lg ">
        <div class="row jutify-content-center">
            ...
            <div class="col-sm-6 col-12 px-4" v-if="!$gate.isProduksi()">
                <div class="float-right">
                    <button class="btn btn-success mr-2" @click="addModal">
                    <i class="fas fa-plus fa-fw"></i>    Pelanggan</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <v-table class="wrap table table-hover tableFixHead text-nowrap" id="table"
                        ...
                        <thead slot="head" style="bg-white">
                            <tr>
                                ...
                                <v-th sortKey="updated_at" defaultSort="desc" v-if="!$gate.isProduksi()">Aksi</v-th>
                            </tr>
                        </thead>
                        <tbody slot="body" slot-scope="{displayData}">
                            ...
                            <tr role="row" class="b-table-busy-slot" v-if="totalItem === 0 && loading === false">
                                <td colspan="9" role="cell" class="">
                                    <div class="text-center text-success my-2">
                                        <strong>Data pelanggan tidak ditemukan</strong>
                                    </div>
                                </td>
                            </tr>
                            <tr v-for="row in displayData" :key="row.id">
                                ...
                                <td style="width: 100px" v-if="!$gate.isProduksi()">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode" id="exampleModalCenterTitle">Tambah Pelanggan Baru</h5>
                    <h5 class="modal-title" v-show="editmode" id="exampleModalCenterTitle">Edit Pelanggan</h5>
                ...
                <form @submit.prevent ="editmode ? updateData() : createData()">
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input v-model="form.nama" type="text" name="nama" placeholder="Nama Pelanggan"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea v-model="form.alamat" type="texta" name="alamat" placeholder="Alamat Pelanggan"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input v-model="form.email" type="email" name="email" placeholder="E-mail Pelanggan"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input v-model="form.telepon" type="number" name="telepon" placeholder="telepon Pelanggan"
            ...
            updateData(){
                ...
                .catch(() => {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Gagal!',
                        text: 'Data pelanggan gagal diperbarui',
                        showConfirmButton: false,
                        timer: 1500,
                    })
                    this.btnload = false;
            ...
            createData(){
                ...
                .catch(()=>{
                    Swal.fire({
                        icon: 'warning',
                        title: 'Gagal!',
                        text: 'Data pelanggan gagal ditambah',
                        showConfirmButton: false,
                        timer: 1500,
                    })
                    this.btnload = false;
